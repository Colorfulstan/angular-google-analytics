export function isPropertyDefined(key, config) {
    return isObject(config) && isDefined(config[key]);
}

export function isPropertySetTo(key, config, value) {
...
////////////////////////////////
// adapted ripoffs from angular sources
////////////////////////////////
/**
 * @ngdoc function
